...
(function () {
  ...
  const productMenuItems = [
    ["Executive Chair", "products-executive-chair.html"],
    ["Executive Mesh Chair", "products-executive-mesh-chair.html"],
    ["Work Station Chair", "products-work-station-chair.html"],
    ["Visitors Chair", "products-visitors-chair.html"],
    ["Cafeteria Chair", "products-cafeteria-chair.html"],
    ["Visitors Sofa", "products-visitors-sofa.html"],
    ["Bar Stools", "products-bar-stools.html"],
    ["Dining Table", "products-dining-table.html"],
    ["Salon Chair", "products-salon-chair.html"],
    ["Office Chair", "products-office-chair.html"],
    ["Boss Chair", "products-boss-chair.html"],
    ["Lounge Chair", "products-lounge-chair.html"],
  ];
